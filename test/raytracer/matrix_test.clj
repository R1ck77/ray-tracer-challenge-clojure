(ns raytracer.matrix-test
  (:require [clojure.test :refer :all]
            [raytracer.test-utils :refer [v= eps= t=] :as test-utils]
...
(deftest test-construction
  ...
  (testing "constructing and inspecting a 3x3 matrix"
    (let [matrix (matrix/create [-3 5 0
                                 1 -2 7
                                 0 1 1])]
...
(deftest test-equality
  (testing "equal matrix"
    (is (v= (matrix/create [1 2 3 4
                            5 6 7 8
                            9 8 7 6
                            5 4 3 2])
            (matrix/create [1 2 3 4
                            5 6 7 8
                            9 8 7 6
                            5 4 3 2]))))
  (testing "different matrix"
    (is (not (v= (matrix/create [1 2 3 4
                                 5 6 7 8
                                 9 8 7 6
                                 5 4 3 2])
                 (matrix/create [1 2 3 4
...
(deftest test-multiply
  (testing "4x4 multiplication"
    (let [m1 (matrix/create [1 2 3 4
                             ...
                             9 8 7 6
                             5 4 3 2])
          m2 (matrix/create [-2 1 2 3
                             3 2 1 -1
                             4 3 6 5
                             1 2 7 8])
          expected (matrix/create [20 22 50 48
                                   44 54 114 108
                                   40 58 110 102
                                   16 26 46 42])]
...
(deftest test-transpose
  (testing "transposing a matrix"
    (is (v= (matrix/create [ 1  2  3  4
                            ...
                            9 10 11 12
                            13 14 15 16])
            (matrix/transpose (matrix/create [1 5  9 13
                                              2 6 10 14
                                              3 7 11 15
                                              4 8 12 16])))))
...
(deftest test-det2
  (testing "2x2 matrix determinant"
    (is (eps= 17 (matrix/det2 (matrix/create [1 5 -3 2]))))))

(deftest test-submatrix
  (testing "a submatrix of a 3x3 matrix is a 2x2 matrix"
    (is (v= (matrix/create [-3 2
                            0 6])
            (matrix/submatrix (matrix/create [ 1 5  0
                                              -3 2  7
                                              0 6 -3]) 3 0 2))))
  (testing "a submatrix of a 4x4 matrix is a 3x3 matrix"
    (is (v= (matrix/create [1 2 3
                            4 5 6
                            7 8 9])
            (matrix/submatrix (matrix/create [1  42  2  3
                                              4  42  5  6
                                              42 42 42 42
                                              7  42  8  9]) 4 2 1)))))
...
(deftest test-minor
  (testing "calculating a minor of a 3x3 matrix"
    (is (eps= 25 (matrix/minor (matrix/create [3 5 0 2 -1 -7 6 -1 5]) 3 1 0)))))

(deftest test-cofactor
  (testing "cofactors of 3x3 matrix"
    (let [m (matrix/create [3  5  0
                            2 -1 -7
                            6 -1  5])]
...
(deftest test-determinant
  (testing "calculating the determinant of a 3x3 matrix"
    (is (eps= -196 (matrix/det (matrix/create [ 1 2  6
                                               -5 8 -4
                                               2 6  4]) 3))))
  (testing "calculating the determinant of a 4x4 matrix"
    (is (eps= -4071 (matrix/det (matrix/create [-2 -8  3  5
                                                -3  1  7  3
                                                1  2 -9  6
                                                -6  7  7 -9]) 4)))))
...
(deftest test-is-invertible?
  (testing "positive case"
    (is (matrix/is-invertible? (matrix/create [6  4 4  4
                                               5  5 7  6
                                               4 -9 3 -7
                                               9  1 7 -6]) 4)))
  (testing "negative case"
    (is (not (matrix/is-invertible? (matrix/create [-4  2 -2 -3
                                                    9  6  2  6
                                                    0 -5  1 -5
                                                    0  0  0  0]) 4)))))

(deftest test-invert
  (with-redefs [test-utils/*eps* 1e-3]
    (testing "inversion 1"
      (let [A (matrix/create [-5  2  6 -8
                              1 -5  1  8
                              7  7 -6 -7
                              1 -3  7  4])]
        (is (v= matrix/identity-matrix 
    ...
    (testing "inversion 2"
      (let [A (matrix/create [8 -5 9 2
        ...
        (is (v= matrix/identity-matrix 
                (matrix/mul4 A (matrix/invert A 4))))))
    (testing "inversion 3"
      (let [A (matrix/create [3 -9 7 3
                              3 -8 2 -9
                              -4 4 4 1
                              -6 5 -1 1])
            B (matrix/create [8 2 2 2
                              3 -1 7 0
                              7 0 5 4
                              6 -2 0 5])
            C (matrix/mul4 A B)]
