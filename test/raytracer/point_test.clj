...
(deftest test-point?
  (testing "point? returns true for tuple when w is 1"
    (is (point/point? [3.5 1.2 5.4 1.0]))
    (is (point/point? [32 12.0 -19.0 (+ 1 1e-7)]))
    (is (point/point? [3.5 1.2 5.4 (- 1 1e-7)])))
  (testing "point? returns false for tuple with w not 1"
    (is (not (point/point? [3.5 1.2 5.4 0])))
    (is (not (point/point? [32 12.0 -19.0 (+ 1 0.002)])))
    (is (not (point/point? [3.5 1.2 5.4 (- 1 0.002)])))))
