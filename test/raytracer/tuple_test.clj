...
(deftest test-add
  (testing "adding two tuple"
    (is (t= (tuple/tuple 1 1 6 1)
                     (.add (tuple/tuple 3 -2 5 1)
                           (tuple/tuple -2 3 1 0))))
    (is (t= (tuple/tuple 11 102 203 0)
                     (.add (tuple/tuple 1 2 3 0)
